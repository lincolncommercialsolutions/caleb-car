    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-text-primary">Our Expertise</h2>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Comprehensive automotive mastery for the most discerning enthusiasts
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-surface via-background to-surface relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl font-bold mb-4 text-text-primary">Ready to Transform Your Drive?</h2>
          <p className="text-xl mb-8 text-text-secondary">Schedule your exclusive consultation today</p>
          <a 
            href="/contact" 
