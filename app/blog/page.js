    ...
    <div className="min-h-screen bg-background">
      <div className="bg-gradient-to-br from-surface via-background to-surface py-20 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-bold mb-4 text-text-primary">Automotive Insights</h1>
          <p className="text-xl text-text-secondary">Expert perspectives on performance, restoration, and automotive excellence</p>
        </div>
      </div>
