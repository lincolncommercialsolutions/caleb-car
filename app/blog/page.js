...
For our clients across the globe who ship their vehicles to our facility, we offer packages ranging from single-stage enhancement to our signature five-stage concierge detail. The investment in proper paint care pays dividends in resale value and the daily pride of driving a vehicle that looks better than the day it left the factory.`
    },
    {
...
Whether you seek an additional 100 HP for daily driving or a full race-spec build pushing 800+ HP, our team has the expertise to deliver results that exceed expectations while maintaining the reliability luxury owners demand.`
    },
    {
...
Our restoration projects serve clients from across North America and internationally who trust their prized vehicles to our care. Whether your classic is a numbers-matching Porsche 911, a pre-war Alfa Romeo, or an American muscle icon, our team possesses the knowledge and passion to honor its heritage while ensuring another generation can experience automotive history at its finest.`
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      <div className="bg-gradient-to-br from-surface via-background to-surface py-12 sm:py-16 md:py-20 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 text-accent">Automotive Insights</h1>
          <p className="text-lg sm:text-xl text-text-secondary">Technical expertise and industry knowledge from our team</p>
        </div>
      </div>
